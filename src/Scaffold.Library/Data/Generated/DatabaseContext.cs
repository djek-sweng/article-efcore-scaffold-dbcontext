...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;port=4200;username=root;password=pasSworD;database=db_scaffold_efcore", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.2.0-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Meeting>(entity =>
        {
            ...
            entity.HasOne(d => d.Calendar).WithMany(p => p.Meetings)
        ...
        modelBuilder.Entity<Reminder>(entity =>
        {
            ...
            entity.HasOne(d => d.Meeting).WithMany(p => p.Reminders)
